  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      if (response.user != null) {
        ...
        Navigator.pushReplacementNamed(context, '/'); // Assuming '/' is your authenticated home screen
      } else {
        ...
        child: Center( // Center the card
          child: SingleChildScrollView(
            ...
            child: Card( // Use a Card for the white, rounded container
              margin: EdgeInsets.symmetric(horizontal: 16.0), // Add some horizontal margin
